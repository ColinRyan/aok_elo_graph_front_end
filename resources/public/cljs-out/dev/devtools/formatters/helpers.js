...
var G__13994 = devtools.prefs.pref.call(null,v);
v = G__13994;
continue;
} else {
return v;
...
}catch (e13997){var _e__12807__auto__ = e13997;
return false;
}})();
...
}catch (e14001){var _e__12807__auto__ = e14001;
return false;
}})();
...
}catch (e14003){var _e__12807__auto__ = e14003;
return false;
}}
}
});
...
var vec__14005 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14005,(0),null);
var name = cljs.core.nth.call(null,vec__14005,(1),null);
...
return cljs.core.some.call(null,(function (p1__14008_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14008_SHARP_);
}),template);
});
