...
var len__4789__auto___21098 = arguments.length;
var i__4790__auto___21099 = (0);
while(true){
if((i__4790__auto___21099 < len__4789__auto___21098)){
args__4795__auto__.push((arguments[i__4790__auto___21099]));

var G__21100 = (i__4790__auto___21099 + (1));
i__4790__auto___21099 = G__21100;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21095){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21096,G__21097,seq21095__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21101_SHARP_){
return (!((cljs.core.meta.call(null,p1__21101_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__21102__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21106){var _e__20299__auto__ = e21106;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e21108){var _e__20299__auto__ = e21108;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21110 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21111 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21111);

try{var map__21112 = opts;
...
var markup_db = cljs.core.get.call(null,map__21112__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21110);
}});
...
var temp__5733__auto___21117 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___21117)){
var managed_print_level_21118 = temp__5733__auto___21117;
var _STAR_print_level_STAR__orig_val__21115_21119 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21116_21120 = managed_print_level_21118;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21116_21120);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__21114_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21114_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21115_21119);
}} else {
job_fn.call(null);
}
