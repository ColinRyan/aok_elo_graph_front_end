...
}catch (e25806){var _e = e25806;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___25809 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___25809)){
var seen_errors_25810 = temp__5733__auto___25809;
if(cljs.core.truth_(seen_errors_25810.has(self))){
} else {
seen_errors_25810.add(self);

var temp__5735__auto___25811 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___25811)){
var sense_25812 = temp__5735__auto___25811;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25812)].join(''));
} else {
}
}
} else {
