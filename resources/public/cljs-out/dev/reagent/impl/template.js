...
var G__12612 = o;
(G__12612[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__12614__i < G__12614__a.length) {G__12614__a[G__12614__i] = arguments[G__12614__i + 0]; ++G__12614__i;}
  args = new cljs.core.IndexedSeq(G__12614__a,0,null);
} 
...
var G__12616 = o;
(G__12616[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12621 = props;
var G__12621__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12621,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12621);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12621__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12622){
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12625){
...
var on_write = cljs.core.get.call(null,map__12626__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__12629 = jsprops;
(G__12629["defaultValue"] = value);

(G__12629["onChange"] = (function (p1__12628_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12628_SHARP_);
}));
...
var vec__12632 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12632,(0),null);
var id = cljs.core.nth.call(null,vec__12632,(1),null);
var class$ = cljs.core.nth.call(null,vec__12632,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___12636 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___12636 == null)){
} else {
var key_12637 = temp__5739__auto___12636;
(jsprops["key"] = key_12637);
}
...
var temp__5739__auto___12638 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___12638 == null)){
} else {
var key_12639 = temp__5739__auto___12638;
reagent.impl.template.oset.call(null,jsprops,"key",key_12639);
}
...
var G__12640 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12640["name"] = c);
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12644){
...
break;
default:
var G__12651 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__12651;
continue;
...
var n__4666__auto___12653 = a.length;
var i_12654 = (0);
while(true){
if((i_12654 < n__4666__auto___12653)){
(a[i_12654] = reagent.impl.template.as_element.call(null,(a[i_12654])));
...
var a = cljs.core.into_array.call(null,s);
var n__4666__auto___12656 = a.length;
var i_12657 = (0);
while(true){
if((i_12657 < n__4666__auto___12656)){
var val_12658 = (a[i_12657]);
if(((cljs.core.vector_QMARK_.call(null,val_12658)) && ((reagent.impl.template.key_from_vec.call(null,val_12658) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12657] = reagent.impl.template.as_element.call(null,val_12658));
...
var ctx = ({});
var vec__12660 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__12660,(0),null);
var derefed = cljs.core.nth.call(null,vec__12660,(1),null);
...
var G__12663 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12663) {
case (0):
