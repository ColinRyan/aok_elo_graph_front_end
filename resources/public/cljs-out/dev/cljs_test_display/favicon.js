...
return cljs.core.map.call(null,(function (p1__20148_SHARP_){
return html_coll.item(p1__20148_SHARP_);
...
return cljs.core.some.call(null,(function (p1__20149_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__20149_SHARP_);
...
var ctx_20150 = cvs.getContext("2d");
(ctx_20150.fillStyle = color);

ctx_20150.fillRect((0),(0),size,size);
