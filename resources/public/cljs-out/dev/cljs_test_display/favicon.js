...
return cljs.core.map.call(null,(function (p1__8575_SHARP_){
return html_coll.item(p1__8575_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__8576_SHARP_);
...
var ctx_8577 = cvs.getContext("2d");
(ctx_8577.fillStyle = color);

ctx_8577.fillRect((0),(0),size,size);
